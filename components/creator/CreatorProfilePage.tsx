    ...
    <main className="relative min-h-screen overflow-hidden bg-black text-white">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 pb-16 pt-8">
        ...
        <section className="mt-8 grid gap-8 lg:grid-cols-[360px_minmax(0,1fr)] lg:items-start xl:grid-cols-[390px_minmax(0,1fr)]">
          <div className="flex min-h-full flex-col items-center gap-2 px-0 py-1 lg:sticky lg:top-24">
            {creatorForCard ? (
              <div className="relative z-10 w-fit scale-[1.1] py-2 sm:scale-[1.16] lg:scale-[1.18] xl:scale-[1.22]">
            ...
            {!isEditing ? (
              <div className="relative z-20 -mt-1 w-full max-w-[340px] rounded-[1.65rem] border border-white/10 bg-white/[0.035] p-4 shadow-2xl shadow-fuchsia-500/5 backdrop-blur-xl sm:max-w-[360px]">
        ...
        {battleModalOpen ? (
          <div className="fixed inset-0 z-[90] flex items-center justify-center bg-black/78 px-4 py-6 backdrop-blur-md" role="dialog" aria-modal="true">
            <div className="relative max-h-[92vh] w-full max-w-7xl overflow-y-auto rounded-[2rem] border border-fuchsia-300/25 bg-[#07040b]/95 p-4 shadow-2xl shadow-fuchsia-500/20 [scrollbar-width:none] [-ms-overflow-style:none] sm:p-6 [&::-webkit-scrollbar]:hidden">
