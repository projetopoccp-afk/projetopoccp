...
export function CreatorStatsModal({
  ...
  return (
    <div className="fixed inset-0 z-[160] flex items-start justify-center overflow-y-auto bg-black/78 px-3 py-4 backdrop-blur-sm sm:px-6 sm:py-6 lg:items-center">
      <button
        type="button"
      ...
      <section className="relative z-10 flex h-[calc(100dvh-2rem)] w-full max-w-5xl flex-col overflow-hidden rounded-[1.65rem] border border-cyan-300/15 bg-[#090b13]/96 shadow-2xl shadow-cyan-500/10 sm:h-[min(90dvh,860px)] sm:rounded-[2rem]">
        ...
        <div className="relative flex shrink-0 items-start justify-between gap-4 border-b border-white/10 px-4 py-4 sm:px-6 sm:py-5 lg:px-7">
          <div className="min-w-0">
            ...
            <h2 className="mt-3 line-clamp-2 text-xl font-black tracking-tight text-white sm:truncate sm:text-3xl">
              {creatorName}
            </h2>
            <p className="mt-1 max-w-2xl text-xs font-semibold leading-5 text-white/55 sm:text-sm sm:leading-6">
              {translate(
                t,
        ...
        <div className="relative flex-1 overflow-y-auto overscroll-contain px-4 py-4 pb-8 sm:px-6 sm:py-5 sm:pb-10 lg:px-7 [scrollbar-width:thin] [scrollbar-color:rgba(34,211,238,0.32)_transparent] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-cyan-300/25 [&::-webkit-scrollbar-track]:bg-transparent">
          ...
          <div className="mt-4 grid gap-3 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="rounded-[1.45rem] border border-cyan-300/15 bg-cyan-300/[0.05] p-4 sm:p-5">
            ...
            <div className="rounded-[1.45rem] border border-fuchsia-300/15 bg-fuchsia-300/[0.045] p-4 sm:p-5">
              <div className="flex items-center justify-between gap-3">
                <div>
          ...
          <div className="mt-4 rounded-[1.45rem] border border-white/10 bg-white/[0.035] p-4 sm:p-5">
            <div className="flex items-center justify-between gap-3">
              <div>
...
function StatCard({
  ...
  return (
    <div className={`rounded-[1.25rem] border p-4 sm:p-5 ${toneClass}`}>
