...
export function CardpocModalShell({
  ...
  return (
    <motion.div
      ...
      onClick={onClose}
      className={`fixed inset-0 ${zIndexClassName} flex min-h-0 items-start justify-center overflow-hidden bg-black/72 p-2 text-white backdrop-blur-[6px] sm:p-3 sm:backdrop-blur-[8px] lg:items-center lg:p-4`}
    >
      <motion.div
        ...
        className={`relative flex h-[calc(100dvh-1rem)] min-h-0 w-full max-w-7xl transform-gpu overflow-hidden rounded-[24px] border border-cyan-200/18 bg-[radial-gradient(circle_at_18%_0%,rgba(236,72,153,0.2),transparent_34%),radial-gradient(circle_at_85%_100%,rgba(34,211,238,0.22),transparent_36%),radial-gradient(circle_at_50%_8%,rgba(168,85,247,0.14),transparent_38%),linear-gradient(135deg,#101322_0%,#0b1020_46%,#050813_100%)] shadow-[0_0_52px_rgba(34,211,238,0.1),0_0_82px_rgba(0,0,0,0.78)] sm:h-[calc(100dvh-1.5rem)] sm:rounded-[30px] sm:shadow-[0_0_72px_rgba(34,211,238,0.12),0_0_100px_rgba(0,0,0,0.8)] lg:h-auto lg:max-h-[calc(100dvh-2rem)] lg:rounded-[34px] ${className}`}
      >
        ...
        <div className="pointer-events-none absolute left-[-82px] top-[-82px] h-52 w-52 rounded-full bg-fuchsia-500/18 blur-[58px] sm:left-[-72px] sm:top-[-72px] sm:h-64 sm:w-64 sm:bg-fuchsia-500/22 sm:blur-[72px] lg:h-80 lg:w-80 lg:bg-fuchsia-500/27 lg:blur-[92px]" />
        <div className="pointer-events-none absolute bottom-[-82px] right-[-82px] h-52 w-52 rounded-full bg-cyan-400/16 blur-[58px] sm:bottom-[-76px] sm:right-[-76px] sm:h-64 sm:w-64 sm:bg-cyan-400/22 sm:blur-[72px] lg:h-80 lg:w-80 lg:bg-cyan-400/25 lg:blur-[92px]" />
        <div className="pointer-events-none absolute left-1/2 top-3 h-44 w-44 -translate-x-1/2 rounded-full bg-purple-500/10 blur-[68px] sm:top-4 sm:h-56 sm:w-56 sm:bg-purple-500/13 sm:blur-[84px] lg:h-72 lg:w-72 lg:bg-purple-500/17 lg:blur-[110px]" />
