export const translations = {
  pt: {
    ...
    adminKickCreatorAlreadyExists: "Já existe",
    adminKickCreatorCategory: "Categoria",
    adminKickCreatorDetectButton: "Detectar na Kick",
    adminKickCreatorDetecting: "Detectando...",
    adminKickCreatorDetectionError: "Não foi possível detectar criadores da Kick agora.",
    adminKickCreatorDetectionSuccess: "Detecção da Kick concluída.",
    adminKickCreatorDetectorBadge: "Kick Detector",
    ...
    adminKickCreatorDetectorTitle: "Detectar Criadores",
    adminKickCreatorHidingExisting: "Ocultando cadastrados",
    adminKickCreatorImportError: "Não foi possível importar os criadores selecionados.",
    adminKickCreatorImportSelected: "Importar selecionados",
    adminKickCreatorImportSuccess: "Criadores da Kick importados como rascunho.",
    adminKickCreatorImporting: "Importando...",
    adminKickCreatorLanguage: "Idioma",
    adminKickCreatorMinViewers: "Viewers mín.",
    adminKickCreatorSelect: "Selecionar",
    adminKickCreatorSelected: "Selecionado",
    adminKickCreatorShowingExisting: "Mostrando cadastrados",
  ...
  en: {
    ...
    adminKickCreatorAlreadyExists: "Already exists",
    adminKickCreatorCategory: "Category",
    adminKickCreatorDetectButton: "Detect on Kick",
    adminKickCreatorDetecting: "Detecting...",
    adminKickCreatorDetectionError: "Could not detect Kick creators right now.",
    adminKickCreatorDetectionSuccess: "Kick detection completed.",
    adminKickCreatorDetectorBadge: "Kick Detector",
    adminKickCreatorDetectorDescription:
      "Search live Kick creators by category, review the results, and import only the selected ones as drafts.",
    adminKickCreatorDetectorTitle: "Detect Creators",
    adminKickCreatorHidingExisting: "Hiding registered",
    adminKickCreatorImportError: "Could not import the selected creators.",
    adminKickCreatorImportSelected: "Import selected",
    adminKickCreatorImportSuccess: "Kick creators imported as drafts.",
    adminKickCreatorImporting: "Importing...",
    adminKickCreatorLanguage: "Language",
    adminKickCreatorMinViewers: "Min. viewers",
    adminKickCreatorSelect: "Select",
    adminKickCreatorSelected: "Selected",
    adminKickCreatorShowingExisting: "Showing registered",
    adminNoKickCreatorsDetected:
      "No creators detected yet. Choose a category and click Detect on Kick.",
    adminOnlyExistingKickCreatorsHidden:
      "The creators found are already registered or do not match the filter. Enable Show registered to review.",
    adminSearchKickCreatorPlaceholder:
  ...
  es: {
    ...
    adminKickCreatorAlreadyExists: "Ya existe",
    adminKickCreatorCategory: "Categoría",
    adminKickCreatorDetectButton: "Detectar en Kick",
    adminKickCreatorDetecting: "Detectando...",
    adminKickCreatorDetectionError: "No fue posible detectar creadores de Kick ahora.",
    adminKickCreatorDetectionSuccess: "Detección de Kick completada.",
    adminKickCreatorDetectorBadge: "Detector Kick",
    adminKickCreatorDetectorDescription:
      "Busca creadores en vivo en Kick por categoría, revisa los resultados e importa solo los seleccionados como borrador.",
    adminKickCreatorDetectorTitle: "Detectar Creadores",
    adminKickCreatorHidingExisting: "Ocultando registrados",
    adminKickCreatorImportError: "No fue posible importar los creadores seleccionados.",
    adminKickCreatorImportSelected: "Importar seleccionados",
    adminKickCreatorImportSuccess: "Creadores de Kick importados como borrador.",
    adminKickCreatorImporting: "Importando...",
    adminKickCreatorLanguage: "Idioma",
    adminKickCreatorMinViewers: "Viewers mín.",
    adminKickCreatorSelect: "Seleccionar",
    adminKickCreatorSelected: "Seleccionado",
    adminKickCreatorShowingExisting: "Mostrando registrados",
    adminNoKickCreatorsDetected:
      "Aún no se detectó ningún creador. Elige una categoría y haz clic en Detectar en Kick.",
    adminOnlyExistingKickCreatorsHidden:
      "Los creadores encontrados ya están registrados o no coinciden con el filtro. Activa Mostrar registrados para revisar.",
    adminSearchKickCreatorPlaceholder:
