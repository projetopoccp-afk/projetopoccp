export const translations = {
  pt: {
    ...
    rankingsEyebrow: "Ranking Cardpoc",
    ...
    rankingsRealDataNotice: "Dados reais do Supabase.",
  ...
  en: {
    ...
    rankingsEyebrow: "Cardpoc Ranking",
    rankingsPageTitle: "Rankings",
    rankingsPageDescription:
      "Track real creator and collector rankings based on Cardpoc data.",
    rankingsYourPosition: "Your position",
    rankingsYourProgressTitle: "Your ranking progress",
    rankingsYourProgressDescription:
      "These positions use only real data from your Cardpoc user account.",
    rankingsYourProgressLoggedOutDescription:
    ...
    rankingsRealDataNotice: "Real Supabase data.",
    ...
    rankingsEmptyDescription:
      "This ranking appears when there are enough real records in Supabase.",
    rankingsCreatorMostCollected: "Most collected",
    rankingsCreatorMostCollectedDescription:
      "Total cards from this creator inside user collections.",
    ...
    rankingsCollectorMostOpenedPacksDescription:
      "Users who opened the most packs in Cardpoc.",
  ...
  es: {
    ...
    rankingsPageTitle: "Rankings",
    rankingsPageDescription:
      "Sigue rankings reales de creadores y coleccionistas según los datos de Cardpoc.",
    rankingsYourPosition: "Tu posición",
    rankingsYourProgressTitle: "Tu progreso en los rankings",
    rankingsYourProgressDescription:
      "Estas posiciones usan solo datos reales de tu usuario en Cardpoc.",
    rankingsYourProgressLoggedOutDescription:
      "Inicia sesión para ver tu posición real en XP, cartas, paquetes y creadores seguidos.",
    rankingsXpPosition: "XP",
    rankingsCardsPosition: "Cartas",
    ...
    rankingsRealDataNotice: "Datos reales de Supabase.",
    rankingsErrorNotice: "No se pudieron cargar algunos datos ahora.",
    rankingsLoading: "Cargando datos reales...",
    rankingsEmptyTitle: "Datos insuficientes",
    rankingsEmptyDescription:
      "Este ranking aparece cuando haya suficientes registros reales en Supabase.",
    rankingsCreatorMostCollected: "Más coleccionado",
    rankingsCreatorMostCollectedDescription:
      "Total de cartas de este creador dentro de las colecciones.",
    ...
    rankingsCollectorMostCardsDescription:
      "Usuarios con más cartas en su colección.",
    rankingsCollectorMostOpenedPacks: "Más paquetes abiertos",
    rankingsCollectorMostOpenedPacksDescription:
      "Quienes más paquetes abrieron dentro de Cardpoc.",
