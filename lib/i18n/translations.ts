export const translations = {
  pt: {
    ...
    rankingsMockNotice:
      "Rankings atualizados com dados reais do Cardpoc.",
    ...
    rankingsCreatorMostRareCardsDescription: "Criadores com mais cartas raras distribuídas.",
    rankingsEmptyTitle: "Sem dados suficientes",
    rankingsEmptyDescription: "Este ranking aparece quando houver registros reais suficientes no Cardpoc.",
    ...
    rankingsYourProgressDescription: "Acompanhe sua evolução em XP, cartas, pacotes e criadores seguidos.",
    rankingsYourProgressLoggedOutDescription: "Entre na sua conta para ver sua posição real em XP, cartas, pacotes e criadores seguidos.",
    rankingsOpenedPacksLabel: "pacotes abertos",
    rankingsFollowedCreatorsLabel: "criadores seguidos",
    rankingsLevelDetailLabel: "nível",
    rankingsAccumulatedXpLabel: "XP acumulado",
    rankingsLegendaryCardsInCollectionsLabel: "lendárias em coleções",
    rankingsEpicCardsInCollectionsLabel: "épicas em coleções",
    rankingsRareCardsInCollectionsLabel: "raras em coleções",
    rankingsNextStepTitle: "Próximo passo",
    rankingsNextStepDescription:
      "Os rankings usam XP, cartas, pacotes e interações reais registradas no Cardpoc.",
  ...
  en: {
    ...
    rankingsMockNotice:
      "Rankings updated with real Cardpoc data.",
    ...
    rankingsYourPositionDescription:
      "Track your progress through XP, cards, packs, and followed creators.",
    rankingsXpPosition: "XP",
    ...
    rankingsCreatorMostRareCardsDescription: "Creators with the most rare cards distributed.",
    rankingsEmptyTitle: "Not enough data yet",
    rankingsEmptyDescription: "This ranking appears when Cardpoc has enough real records.",
    rankingsErrorNotice: "Some ranking data could not be loaded right now.",
    ...
    rankingsYourProgressDescription: "Track your progress through XP, cards, packs, and followed creators.",
    rankingsYourProgressLoggedOutDescription: "Sign in to see your real position in XP, cards, packs, and followed creators.",
    rankingsOpenedPacksLabel: "opened packs",
    rankingsFollowedCreatorsLabel: "followed creators",
    rankingsLevelDetailLabel: "level",
    rankingsAccumulatedXpLabel: "accumulated XP",
    rankingsLegendaryCardsInCollectionsLabel: "legendary cards in collections",
    rankingsEpicCardsInCollectionsLabel: "epic cards in collections",
    rankingsRareCardsInCollectionsLabel: "rare cards in collections",
    rankingsNextStepTitle: "Next step",
    rankingsNextStepDescription:
      "Rankings use real XP, cards, packs, and interactions recorded in Cardpoc.",
  ...
  es: {
    ...
    rankingsMockNotice:
      "Rankings actualizados con datos reales de Cardpoc.",
    ...
    rankingsYourPositionDescription:
      "Sigue tu evolución en XP, cartas, paquetes y creadores seguidos.",
    rankingsXpPosition: "XP",
    rankingsCardsPosition: "Cartas",
    rankingsPacksPosition: "Paquetes",
    rankingsFollowingPosition: "Siguiendo",
    rankingsCreatorMostRareCards: "Más cartas raras",
    rankingsCreatorMostRareCardsDescription: "Creadores con más cartas raras distribuidas.",
    rankingsEmptyTitle: "Datos insuficientes",
    rankingsEmptyDescription: "Este ranking aparecerá cuando Cardpoc tenga registros reales suficientes.",
    rankingsErrorNotice: "No fue posible cargar algunos datos de rankings ahora.",
    ...
    rankingsYourProgressDescription: "Sigue tu evolución en XP, cartas, paquetes y creadores seguidos.",
    rankingsYourProgressLoggedOutDescription: "Inicia sesión para ver tu posición real en XP, cartas, paquetes y creadores seguidos.",
    rankingsOpenedPacksLabel: "paquetes abiertos",
    rankingsFollowedCreatorsLabel: "creadores seguidos",
    rankingsLevelDetailLabel: "nivel",
    rankingsAccumulatedXpLabel: "XP acumulada",
    rankingsLegendaryCardsInCollectionsLabel: "legendarias en colecciones",
    rankingsEpicCardsInCollectionsLabel: "épicas en colecciones",
    rankingsRareCardsInCollectionsLabel: "raras en colecciones",
    rankingsNextStepTitle: "Próximo paso",
    rankingsNextStepDescription:
      "Los rankings usan XP, cartas, paquetes e interacciones reales registradas en Cardpoc.",
