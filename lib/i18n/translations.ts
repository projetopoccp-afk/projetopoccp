export const translations = {
  pt: {
    ...
    liveDropsActiveDrops: "Drops ativos",
    liveDropsRecentDrops: "Últimos drops",
    liveDropsNoActiveDrops: "Nenhum drop ativo no momento.",
    liveDropsNoRecentDrops: "Nenhum drop criado ainda.",
    liveDropsEndDrop: "Encerrar drop",
    liveDropsEndError: "Não foi possível encerrar o drop.",
    liveDropsEnded: "Drop encerrado.",
    liveDropsClaimsCount: "resgatados",
    liveDropsMaxClaims: "vagas",

    liveDropsListError: "Could not load drops right now.",
    liveDropsActiveDrops: "Active drops",
    liveDropsRecentDrops: "Recent drops",
    liveDropsNoActiveDrops: "No active drops right now.",
    liveDropsNoRecentDrops: "No drops created yet.",
    liveDropsEndDrop: "End drop",
    liveDropsEndError: "Could not end the drop.",
    liveDropsEnded: "Drop ended.",
    liveDropsClaimsCount: "claimed",
    liveDropsMaxClaims: "slots",

    liveDropsListError: "No se pudieron cargar los drops ahora.",
    liveDropsActiveDrops: "Drops activos",
    liveDropsRecentDrops: "Últimos drops",
    liveDropsNoActiveDrops: "No hay drops activos ahora.",
    liveDropsNoRecentDrops: "Aún no se crearon drops.",
    liveDropsEndDrop: "Finalizar drop",
    liveDropsEndError: "No se pudo finalizar el drop.",
    liveDropsEnded: "Drop finalizado.",
    liveDropsClaimsCount: "rescatados",
    liveDropsMaxClaims: "cupos",
    email: "Email",
  },
