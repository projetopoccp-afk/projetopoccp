const supplementalTranslations = {
  pt: {
    accountPageBackHome: "Voltar para home",
    accountPageCreatorCollectionDescription:
      "Em breve você poderá seguir, favoritar e colecionar cards de creators.",
    accountPageCreatorCollectionTitle: "Coleção de criadores",
    accountPageLoading: "Carregando conta...",
    achievements: "Conquistas",
    adminActionCompleted: "Ação concluída",
    adminActiveConversations: "ativas",
    adminAllOwners: "Com ou sem dono",
    adminAllProfiles: "Todos os perfis",
    adminAllVerification: "Todos",
    adminBulkHideSuccess: "Perfis filtrados ocultados com sucesso.",
    adminBulkPublishSuccess: "Perfis filtrados publicados com sucesso.",
    adminBulkVerifySuccess: "Perfis filtrados verificados com sucesso.",
    adminChangeCreatorImage: "Alterar imagem",
    adminClearProfileFilters: "Limpar filtros",
    ...
    adminConversationFilterActive: "Ativas",
    adminConversationsTitle: "Central de conversas",
    adminCreatorAdvancedSearch: "Pesquisa avançada",
    ...
    adminCreatorImage: "Imagem do criador",
    adminCreatorImagePreview: "Prévia da imagem",
    adminCreatorImageRequired:
      "Informe uma URL ou selecione uma imagem para upload.",
    adminCreatorImageUpdated: "Imagem do perfil atualizada.",
    adminCreatorImageUpload: "Upload de arquivo",
    adminCreatorImageUploadHint:
      "Use uma imagem vertical para preservar o visual premium da carta.",
    adminCreatorImageUrl: "URL da imagem",
    adminDefaultCreatorBio: "Novo criador aprovado na plataforma.",
    adminDefaultCreatorDescription:
      "Este perfil foi aprovado e poderá ser personalizado pelo criador em breve.",
    adminDefaultCreatorTitle: "Criador de Conteúdo",
    adminHideFilteredProfiles: "Ocultar filtrados",
    adminNeedReply: "aguardando equipe",
    adminNoConversationMessages:
      "Nenhuma mensagem encontrada nesta conversa.",
    adminNoConversationsFound: "Nenhuma conversa encontrada para este filtro.",
    adminNoFilteredProfilesToUpdate:
      "Nenhum perfil filtrado precisa dessa alteração.",
    adminOnlyClaimed: "Reivindicados",
    adminOnlyHiddenProfiles: "Apenas ocultos",
    adminOnlyNotVerified: "Não verificados",
    adminOnlyPublicProfiles: "Apenas publicados",
    adminOnlyUnclaimed: "Sem dono",
    adminOnlyVerified: "Verificados",
    adminOpenPanel: "Abrir painel admin",
    adminOwnerFilter: "Dono",
    adminPageAccessDeniedDescription:
      "Esta área é restrita para administradores.",
    adminPageAccessDeniedTitle: "Acesso negado",
    adminPagePendingRequestsDescription:
      "Solicitações pendentes de aprovação.",
    adminProfilesFiltered: "filtrados",
    adminPublishFilteredProfiles: "Publicar filtrados",
    adminSearchConversationsPlaceholder:
      "Buscar por usuário, assunto, tipo ou perfil...",
    adminSortFollowers: "Mais seguidores",
    adminSortName: "Nome",
    adminSortNewest: "Mais recentes",
    adminSortOldest: "Mais antigos",
    adminSortProfiles: "Ordenar",
    adminSortShares: "Mais shares",
    adminSortTrending: "Trending",
    adminSortViews: "Mais visualizações",
    adminTargetId: "Target ID",
    adminTeamCardpoc: "Equipe Cardpoc",
    adminVerificationFilter: "Verificação",
    adminVerifyFilteredProfiles: "Verificar filtrados",
    adminVisibilityFilter: "Visibilidade",
    albumPageClearSearch: "Limpar",
    albumPageClickToReveal: "Clique para revelar",
    albumPageFilterAll: "Todos",
    albumPageFilterClosest: "Mais próximos",
    albumPageFilterComplete: "Completos",
    albumPageFilterHighlights: "Destaques",
    albumPageFilterIncomplete: "Incompletos",
    albumPageFilterMythics: "Míticas",
    albumPageFilterReady: "Revelar",
    albumPageMissingRarities: "Falta: {rarities}",
    albumPageMythicBadge: "Mítica",
    albumPageMythicUnlocked: "Mítica desbloqueada",
    albumPageNoCreatorCards: "Você ainda não possui cartas deste criador.",
    albumPageNoFilteredSlots:
      "Nenhum slot encontrado com os filtros atuais.",
    albumPageOpenCreatorAria: "Abrir criador {creator}",
    albumPageReady: "Pronta",
    albumPageRevealMythicAria: "Revelar carta mítica de {creator}",
    albumPageSearchPlaceholder: "Buscar dentro do álbum...",
    albumPageTileProgress: "Progresso {count}/4",
    albumPageVisibleSlots:
      "Exibindo {visible} de {total} slots do seu álbum.",
    badgeUnlockedToast: "Badge desbloqueada",
    cardHoarder: "50 Cartas",
    cardHoarderDescription: "Colecione 50 cartas no Cardpoc.",
    cardNotificationToast: "Nova carta",
    cardShareDescription:
      "Esta carta pode ser compartilhada nas redes sociais.",
    closeNotification: "Fechar notificação",
    collectorProfile: "Perfil de Colecionador",
    collectorTitleCollector: "Colecionador",
    collectorTitleElite: "Colecionador Elite",
    collectorTitleEpic: "Caçador Épico",
    collectorTitleLegend: "Lenda Cardpoc",
    collectorTitleRookie: "Recruta Cardpoc",
    creatorPopupImageEffectBloom: "Florescer místico",
    creatorPopupImageEffectBloomDescription:
      "Pétalas de energia, pólen luminoso e aura viva.",
    creatorPopupImageEffectEclipse: "Eclipse sombrio",
    creatorPopupImageEffectEclipseDescription:
      "Anéis de eclipse, sombra orbital e brilho frio.",
    creatorPopupImageEffectFrost: "Geada ártica",
    creatorPopupImageEffectFrostDescription:
      "Cristais de gelo, neve luminosa e névoa fria.",
    creatorPopupImageEffectGlitch: "Glitch dimensional",
    creatorPopupImageEffectGlitchDescription:
      "Falhas digitais, cortes RGB e deslocamentos rápidos.",
    creatorPopupImageEffectInferno: "Inferno rubi",
    creatorPopupImageEffectInfernoDescription:
      "Chamas rubi, brasas e ondas de calor.",
    creatorPopupImageEffectNebula: "Nebulosa cósmica",
    creatorPopupImageEffectNebulaDescription:
      "Nuvens cósmicas, estrelas e poeira espacial.",
    creatorProfileBattleClose: "Fechar batalha",
    creatorProfileEditAddSocialLinkShort: "Adicionar",
    creatorProfileEditBioPlaceholder: "Resumo curto para o topo do perfil.",
    creatorProfileEditCategoryPlaceholder: "Black Desert, MMORPG, Lives...",
    creatorProfileEditCloseAria: "Fechar edição de perfil",
    creatorProfileEditDescriptionPlaceholder:
      "Conte mais sobre o criador, comunidade, conteúdo e objetivos.",
    creatorProfileEditNicknamePlaceholder: "Nome do criador",
    creatorProfileEditPresentationEffects: "Efeitos de apresentação",
    creatorProfileEditPublicInfoDescription:
      "Atualize somente as informações públicas que aparecem no Cardpoc.",
    creatorProfileEditRemoveSocialLinkShort: "Remover",
    creatorProfileEditSelectSocialNetwork: "Selecione a rede",
    creatorProfileEditSocialLinksDescription:
      "Adicione links públicos que aparecem no perfil.",
    creatorProfileEditTagsHelp: "Separe as tags por vírgula.",
    creatorProfileEditTagsPlaceholder: "Streamer, MMORPG, Black Desert",
    ...
    creatorProfileStatsAverage: "Média",
    creatorProfileStatsAveragePerFan: "Média por fã",
    creatorProfileStatsCardpocProgress: "Progresso no Cardpoc",
    creatorProfileStatsClaimHelpsFollowers:
      "Reivindicar e divulgar o perfil ajuda a ativar os primeiros seguidores.",
    creatorProfileStatsClose: "Fechar estatísticas",
    creatorProfileStatsCollectedCards: "Cartas coletadas",
    creatorProfileStatsCollection: "Coleção",
    ...
    creatorProfileStatsCommunity: "Comunidade",
    ...
    creatorProfileStatsEngagement: "Engajamento",
    creatorProfileStatsExternalMetric: "Métrica externa",
    creatorProfileStatsExternalNetworks: "Redes externas",
    creatorProfileStatsFollowersHelp:
      "Seguidores no Cardpoc ajudam o criador a ganhar relevância interna.",
    creatorProfileStatsGrowth: "Crescimento",
    ...
    creatorProfileStatsImpactSummary: "Resumo de impacto",
    creatorProfileStatsLive: "Ao vivo",
    creatorProfileStatsLiveNow: "Ao vivo agora",
    creatorProfileStatsNextStep: "Próximo passo",
    creatorProfileStatsNoExternalMetrics:
      "Ainda não há métricas externas disponíveis para este perfil.",
    creatorProfileStatsOffPlatformReach: "Alcance fora da plataforma",
    creatorProfileStatsPotential: "Potencial",
    creatorProfileStatsProfileHealth: "Saúde do perfil",
    ...
    creatorProfileStatsQuickRead: "Leitura rápida",
    ...
    creatorProfileStatsReach: "Alcance",
    creatorProfileStatsStrengthActivePotential: "Potencial ativo",
    creatorProfileStatsStrengthGrowing: "Em crescimento",
    creatorProfileStatsStrengthInitial: "Base inicial",
    creatorProfileStatsStrengthStrong: "Perfil forte",
    drops: "Drops",
    epicHunter: "Caçador Épico",
    epicHunterDescription: "Conquiste uma carta épica ou superior.",
    legendaryHunter: "Caçador de Lendárias",
    legendaryHunterDescription:
      "Adicione uma carta lendária à sua coleção.",
    levelTen: "Nível 10",
    levelTenDescription: "Alcance o nível 10 como colecionador.",
    levelUpToast: "Level up",
    loading: "Carregando",
    missionCompletedToast: "Missão completa",
    missionsCategoryBeginner: "Iniciante",
    missionsCategoryCollection: "Coleção",
    missionsCategoryCreators: "Criadores",
    missionsCategoryPacks: "Packs",
    missionsCategoryRarities: "Raridades",
    missionsCategorySocial: "Social",
    newNotification: "Nova notificação",
    obtainedFrom: "Origem",
    openPack: "Abrir pacote",
    packOpenedToast: "Pacote aberto",
    packReceivedToast: "Pacote recebido",
    ...
    profileHighlightTitle: "Destaque da coleção",
    ...
    rankingsEmptyTitle: "Sem dados suficientes",
    rankingsErrorNotice: "Não foi possível carregar alguns dados agora.",
    rankingsLoading: "Carregando dados reais...",
    rankingsRealDataNotice: "Rankings atualizados com dados reais.",
    ...
    rankingsYourProgressTitle: "Seu progresso nos rankings",
    rareCollector: "Colecionador Raro",
    rareCollectorDescription: "Tenha pelo menos uma carta rara ou superior.",
    send: "Enviar",
    viewBadge: "Ver badge",
    viewCard: "Ver carta",
  ...
  en: {
    accountPageBackHome: "Back to home",
    accountPageCreatorCollectionDescription:
      "Soon you will be able to follow, favorite, and collect creator cards.",
    accountPageCreatorCollectionTitle: "Creator collection",
    accountPageLoading: "Loading account...",
    achievements: "Achievements",
    adminActionCompleted: "Action completed",
    adminActiveConversations: "active",
    adminAllOwners: "With or without owner",
    adminAllProfiles: "All profiles",
    adminAllVerification: "All",
    adminBulkHideSuccess: "Filtered profiles hidden successfully.",
    adminBulkPublishSuccess: "Filtered profiles published successfully.",
    adminBulkVerifySuccess: "Filtered profiles verified successfully.",
    adminChangeCreatorImage: "Change image",
    adminClearProfileFilters: "Clear filters",
    adminClosedConversationHint:
      "This conversation has been finished. Reopen it by changing the status to Open/Waiting before replying.",
    adminConfirmBulkCreatorUpdate:
      "Apply this change to {count} filtered profile(s)?",
    adminConversationFilterActive: "Active",
    adminConversationsTitle: "Conversation center",
    adminCreatorAdvancedSearch: "Advanced search",
    adminCreatorAdvancedSearchDescription:
      "Filter profiles by visibility, verification, and owner. Bulk actions affect only the filtered results.",
    adminCreatorImage: "Creator image",
    adminCreatorImagePreview: "Image preview",
    adminCreatorImageRequired:
      "Enter a URL or select an image to upload.",
    adminCreatorImageUpdated: "Profile image updated.",
    adminCreatorImageUpload: "File upload",
    adminCreatorImageUploadHint:
      "Use a vertical image to preserve the card's premium look.",
    adminCreatorImageUrl: "Image URL",
    adminDefaultCreatorBio: "New creator approved on the platform.",
    adminDefaultCreatorDescription:
      "This profile was approved and can be customized by the creator soon.",
    adminDefaultCreatorTitle: "Content Creator",
    adminHideFilteredProfiles: "Hide filtered",
    adminNeedReply: "waiting for team",
    adminNoConversationMessages: "No messages found in this conversation.",
    adminNoConversationsFound: "No conversations found for this filter.",
    adminNoFilteredProfilesToUpdate:
      "No filtered profile needs this change.",
    adminOnlyClaimed: "Claimed",
    adminOnlyHiddenProfiles: "Only hidden",
    adminOnlyNotVerified: "Not verified",
    adminOnlyPublicProfiles: "Only published",
    adminOnlyUnclaimed: "Without owner",
    adminOnlyVerified: "Verified",
    adminOpenPanel: "Open admin panel",
    adminOwnerFilter: "Owner",
    adminPageAccessDeniedDescription:
      "This area is restricted to administrators.",
    adminPageAccessDeniedTitle: "Access denied",
    adminPagePendingRequestsDescription: "Requests pending approval.",
    adminProfilesFiltered: "filtered",
    adminPublishFilteredProfiles: "Publish filtered",
    adminSearchConversationsPlaceholder:
      "Search by user, subject, type, or profile...",
    adminSortFollowers: "Most followers",
    adminSortName: "Name",
    adminSortNewest: "Newest",
    adminSortOldest: "Oldest",
    adminSortProfiles: "Sort",
    adminSortShares: "Most shares",
    adminSortTrending: "Trending",
    adminSortViews: "Most views",
    adminTargetId: "Target ID",
    adminTeamCardpoc: "Cardpoc Team",
    adminVerificationFilter: "Verification",
    adminVerifyFilteredProfiles: "Verify filtered",
    adminVisibilityFilter: "Visibility",
    albumPageClearSearch: "Clear",
    albumPageClickToReveal: "Click to reveal",
    albumPageFilterAll: "All",
    albumPageFilterClosest: "Closest",
    albumPageFilterComplete: "Complete",
    albumPageFilterHighlights: "Highlights",
    albumPageFilterIncomplete: "Incomplete",
    albumPageFilterMythics: "Mythics",
    albumPageFilterReady: "Reveal",
    albumPageMissingRarities: "Missing: {rarities}",
    albumPageMythicBadge: "Mythic",
    albumPageMythicUnlocked: "Mythic unlocked",
    albumPageNoCreatorCards: "You do not have cards from this creator yet.",
    albumPageNoFilteredSlots: "No slots found with the current filters.",
    albumPageOpenCreatorAria: "Open creator {creator}",
    albumPageReady: "Ready",
    albumPageRevealMythicAria: "Reveal mythic card from {creator}",
    albumPageSearchPlaceholder: "Search inside the album...",
    albumPageTileProgress: "Progress {count}/4",
    albumPageVisibleSlots:
      "Showing {visible} of {total} slots in your album.",
    badgeUnlockedToast: "Badge unlocked",
    cardHoarder: "50 Cards",
    cardHoarderDescription: "Collect 50 cards on Cardpoc.",
    cardNotificationToast: "New card",
    cardShareDescription: "This card can be shared on social media.",
    closeNotification: "Close notification",
    collectorProfile: "Collector Profile",
    collectorTitleCollector: "Collector",
    collectorTitleElite: "Elite Collector",
    collectorTitleEpic: "Epic Hunter",
    collectorTitleLegend: "Cardpoc Legend",
    collectorTitleRookie: "Cardpoc Rookie",
    creatorPopupImageEffectBloom: "Mystic bloom",
    creatorPopupImageEffectBloomDescription:
      "Energy petals, glowing pollen, and a living aura.",
    creatorPopupImageEffectEclipse: "Dark eclipse",
    creatorPopupImageEffectEclipseDescription:
      "Eclipse rings, orbital shadow, and a cold glow.",
    creatorPopupImageEffectFrost: "Arctic frost",
    creatorPopupImageEffectFrostDescription:
      "Ice crystals, luminous snow, and cold mist.",
    creatorPopupImageEffectGlitch: "Dimensional glitch",
    creatorPopupImageEffectGlitchDescription:
      "Digital glitches, RGB cuts, and fast offsets.",
    creatorPopupImageEffectInferno: "Ruby inferno",
    creatorPopupImageEffectInfernoDescription:
      "Ruby flames, embers, and heat waves.",
    creatorPopupImageEffectNebula: "Cosmic nebula",
    creatorPopupImageEffectNebulaDescription:
      "Cosmic clouds, stars, and space dust.",
    creatorProfileBattleClose: "Close battle",
    creatorProfileEditAddSocialLinkShort: "Add",
    creatorProfileEditBioPlaceholder:
      "Short summary for the top of the profile.",
    creatorProfileEditCategoryPlaceholder: "Black Desert, MMORPG, Lives...",
    creatorProfileEditCloseAria: "Close profile editing",
    creatorProfileEditDescriptionPlaceholder:
      "Tell more about the creator, community, content, and goals.",
    creatorProfileEditNicknamePlaceholder: "Creator name",
    creatorProfileEditPresentationEffects: "Presentation effects",
    creatorProfileEditPublicInfoDescription:
      "Update only the public information that appears on Cardpoc.",
    creatorProfileEditRemoveSocialLinkShort: "Remove",
    creatorProfileEditSelectSocialNetwork: "Select network",
    creatorProfileEditSocialLinksDescription:
      "Add public links that appear on the profile.",
    creatorProfileEditTagsHelp: "Separate tags with commas.",
    creatorProfileEditTagsPlaceholder: "Streamer, MMORPG, Black Desert",
    creatorProfileEditTitlePlaceholder:
      "Streamer, creator, guild leader...",
    creatorProfileSaveChanges: "Save changes",
    creatorProfileStatsActivateDrops:
      "Activating drops during lives can speed up collection, interaction, and profile return.",
    creatorProfileStatsAverage: "Average",
    creatorProfileStatsAveragePerFan: "Average per fan",
    creatorProfileStatsCardpocProgress: "Cardpoc progress",
    creatorProfileStatsClaimHelpsFollowers:
      "Claiming and sharing the profile helps activate the first followers.",
    creatorProfileStatsClose: "Close statistics",
    creatorProfileStatsCollectedCards: "Collected cards",
    creatorProfileStatsCollection: "Collection",
    creatorProfileStatsCollectorsActive:
      "This profile already has active collectors on Cardpoc.",
    creatorProfileStatsCollectorsStarting:
      "This profile is still starting its collector base.",
    creatorProfileStatsCommunity: "Community",
    creatorProfileStatsContinueDrops:
      "Keep using drops to turn viewers into participants.",
    creatorProfileStatsDescription:
      "Summary of creator growth, collection, and reach inside and outside Cardpoc.",
    creatorProfileStatsEngagement: "Engagement",
    creatorProfileStatsExternalMetric: "External metric",
    creatorProfileStatsExternalNetworks: "External networks",
    creatorProfileStatsFollowersHelp:
      "Cardpoc followers help the creator gain internal relevance.",
    creatorProfileStatsGrowth: "Growth",
    creatorProfileStatsGrowthDescription:
      "The more the profile is visited, followed, shared, collected, and used in drops, the more it tends to grow inside Cardpoc.",
    creatorProfileStatsImpactSummary: "Impact summary",
    creatorProfileStatsLive: "Live",
    creatorProfileStatsLiveNow: "Live now",
    creatorProfileStatsNextStep: "Next step",
    creatorProfileStatsNoExternalMetrics:
      "No external metrics are available for this profile yet.",
    creatorProfileStatsOffPlatformReach: "Off-platform reach",
    creatorProfileStatsPotential: "Potential",
    creatorProfileStatsProfileHealth: "Profile health",
    creatorProfileStatsProfileHealthDescription:
      "Estimated score using visits, followers, shares, collection, drops, and external reach already available on Cardpoc.",
    creatorProfileStatsQuickRead: "Quick read",
    creatorProfileStatsQuickReadDescription:
      "Use these numbers to understand whether the creator is attracting visits, converting followers, and generating collection inside the community.",
    creatorProfileStatsReach: "Reach",
    creatorProfileStatsStrengthActivePotential: "Active potential",
    creatorProfileStatsStrengthGrowing: "Growing",
    creatorProfileStatsStrengthInitial: "Initial base",
    creatorProfileStatsStrengthStrong: "Strong profile",
    drops: "Drops",
    epicHunter: "Epic Hunter",
    epicHunterDescription: "Get an epic card or higher.",
    legendaryHunter: "Legendary Hunter",
    legendaryHunterDescription: "Add a legendary card to your collection.",
    levelTen: "Level 10",
    levelTenDescription: "Reach level 10 as a collector.",
    levelUpToast: "Level up",
    loading: "Loading",
    missionCompletedToast: "Mission complete",
    missionsCategoryBeginner: "Beginner",
    missionsCategoryCollection: "Collection",
    missionsCategoryCreators: "Creators",
    missionsCategoryPacks: "Packs",
    missionsCategoryRarities: "Rarities",
    missionsCategorySocial: "Social",
    newNotification: "New notification",
    obtainedFrom: "Source",
    openPack: "Open pack",
    packOpenedToast: "Pack opened",
    packReceivedToast: "Pack received",
    profileHighlightDescription:
      "Your highest-rarity card obtained so far.",
    profileHighlightEmpty:
      "Your featured card will appear here when you start collecting.",
    profileHighlightTitle: "Collection highlight",
    rankingsCreatorMostRareCards: "Most rare cards",
    rankingsCreatorMostRareCardsDescription:
      "Creators with the most rare cards distributed.",
    rankingsEmptyDescription:
      "This ranking appears when there are enough real records on Cardpoc.",
    rankingsEmptyTitle: "Not enough data",
    rankingsErrorNotice: "Some data could not be loaded right now.",
    rankingsLoading: "Loading real data...",
    rankingsRealDataNotice: "Rankings updated with real data.",
    rankingsYourProgressDescription:
      "Track your progress in XP, cards, packs, and followed creators.",
    rankingsYourProgressLoggedOutDescription:
      "Sign in to see your real position in XP, cards, packs, and followed creators.",
    rankingsYourProgressTitle: "Your ranking progress",
    rareCollector: "Rare Collector",
    rareCollectorDescription: "Have at least one rare card or higher.",
    send: "Send",
  ...
  es: {
    accountPageBackHome: "Volver al inicio",
    accountPageCreatorCollectionDescription:
      "Pronto podrás seguir, marcar como favorito y coleccionar cartas de creadores.",
    accountPageCreatorCollectionTitle: "Colección de creadores",
    accountPageLoading: "Cargando cuenta...",
    achievements: "Logros",
    adminActionCompleted: "Acción completada",
    adminActiveConversations: "activas",
    adminAllOwners: "Con o sin dueño",
    adminAllProfiles: "Todos los perfiles",
    adminAllVerification: "Todos",
    adminBulkHideSuccess: "Perfiles filtrados ocultados correctamente.",
    adminBulkPublishSuccess: "Perfiles filtrados publicados correctamente.",
    adminBulkVerifySuccess: "Perfiles filtrados verificados correctamente.",
    adminChangeCreatorImage: "Cambiar imagen",
    adminClearProfileFilters: "Limpiar filtros",
    adminClosedConversationHint:
      "Esta conversación fue finalizada. Reábrela cambiando el estado a Abierto/Esperando antes de responder.",
    adminConfirmBulkCreatorUpdate:
      "¿Aplicar este cambio a {count} perfil(es) filtrado(s)?",
    adminConversationFilterActive: "Activas",
    adminConversationsTitle: "Central de conversaciones",
    adminCreatorAdvancedSearch: "Búsqueda avanzada",
    adminCreatorAdvancedSearchDescription:
      "Filtra perfiles por visibilidad, verificación y dueño. Las acciones masivas afectan solo el resultado filtrado.",
    adminCreatorImage: "Imagen del creador",
    adminCreatorImagePreview: "Vista previa de la imagen",
    adminCreatorImageRequired:
      "Informa una URL o selecciona una imagen para subir.",
    adminCreatorImageUpdated: "Imagen del perfil actualizada.",
    adminCreatorImageUpload: "Subida de archivo",
    adminCreatorImageUploadHint:
      "Usa una imagen vertical para preservar el aspecto premium de la carta.",
    adminCreatorImageUrl: "URL de la imagen",
    adminDefaultCreatorBio: "Nuevo creador aprobado en la plataforma.",
    adminDefaultCreatorDescription:
      "Este perfil fue aprobado y pronto podrá ser personalizado por el creador.",
    adminDefaultCreatorTitle: "Creador de Contenido",
    adminHideFilteredProfiles: "Ocultar filtrados",
    adminNeedReply: "esperando equipo",
    adminNoConversationMessages:
      "No se encontraron mensajes en esta conversación.",
    adminNoConversationsFound:
      "No se encontraron conversaciones para este filtro.",
    adminNoFilteredProfilesToUpdate:
      "Ningún perfil filtrado necesita este cambio.",
    adminOnlyClaimed: "Reivindicados",
    adminOnlyHiddenProfiles: "Solo ocultos",
    adminOnlyNotVerified: "No verificados",
    adminOnlyPublicProfiles: "Solo publicados",
    adminOnlyUnclaimed: "Sin dueño",
    adminOnlyVerified: "Verificados",
    adminOpenPanel: "Abrir panel admin",
    adminOwnerFilter: "Dueño",
    adminPageAccessDeniedDescription:
      "Esta área está restringida a administradores.",
    adminPageAccessDeniedTitle: "Acceso denegado",
    adminPagePendingRequestsDescription:
      "Solicitudes pendientes de aprobación.",
    adminProfilesFiltered: "filtrados",
    adminPublishFilteredProfiles: "Publicar filtrados",
    adminSearchConversationsPlaceholder:
      "Buscar por usuario, asunto, tipo o perfil...",
    adminSortFollowers: "Más seguidores",
    adminSortName: "Nombre",
    adminSortNewest: "Más recientes",
    adminSortOldest: "Más antiguos",
    adminSortProfiles: "Ordenar",
    adminSortShares: "Más compartidos",
    adminSortTrending: "Trending",
    adminSortViews: "Más visualizaciones",
    adminTargetId: "Target ID",
    adminTeamCardpoc: "Equipo Cardpoc",
    adminVerificationFilter: "Verificación",
    adminVerifyFilteredProfiles: "Verificar filtrados",
    adminVisibilityFilter: "Visibilidad",
    albumPageClearSearch: "Limpiar",
    albumPageClickToReveal: "Haz clic para revelar",
    albumPageFilterAll: "Todos",
    albumPageFilterClosest: "Más cercanos",
    albumPageFilterComplete: "Completos",
    albumPageFilterHighlights: "Destacados",
    albumPageFilterIncomplete: "Incompletos",
    albumPageFilterMythics: "Míticas",
    albumPageFilterReady: "Revelar",
    albumPageMissingRarities: "Falta: {rarities}",
    albumPageMythicBadge: "Mítica",
    albumPageMythicUnlocked: "Mítica desbloqueada",
    albumPageNoCreatorCards: "Aún no tienes cartas de este creador.",
    albumPageNoFilteredSlots:
      "No se encontraron slots con los filtros actuales.",
    albumPageOpenCreatorAria: "Abrir creador {creator}",
    albumPageReady: "Lista",
    albumPageRevealMythicAria: "Revelar carta mítica de {creator}",
    albumPageSearchPlaceholder: "Buscar dentro del álbum...",
    albumPageTileProgress: "Progreso {count}/4",
    albumPageVisibleSlots:
      "Mostrando {visible} de {total} slots de tu álbum.",
    badgeUnlockedToast: "Badge desbloqueada",
    cardHoarder: "50 Cartas",
    cardHoarderDescription: "Colecciona 50 cartas en Cardpoc.",
    cardNotificationToast: "Nueva carta",
    cardShareDescription: "Esta carta puede compartirse en redes sociales.",
    closeNotification: "Cerrar notificación",
    collectorProfile: "Perfil de Coleccionista",
    collectorTitleCollector: "Coleccionista",
    collectorTitleElite: "Coleccionista Elite",
    collectorTitleEpic: "Cazador Épico",
    collectorTitleLegend: "Leyenda Cardpoc",
    collectorTitleRookie: "Recluta Cardpoc",
    creatorPopupImageEffectBloom: "Florecer místico",
    creatorPopupImageEffectBloomDescription:
      "Pétalos de energía, polen luminoso y aura viva.",
    creatorPopupImageEffectEclipse: "Eclipse sombrío",
    creatorPopupImageEffectEclipseDescription:
      "Anillos de eclipse, sombra orbital y brillo frío.",
    creatorPopupImageEffectFrost: "Escarcha ártica",
    creatorPopupImageEffectFrostDescription:
      "Cristales de hielo, nieve luminosa y niebla fría.",
    creatorPopupImageEffectGlitch: "Glitch dimensional",
    creatorPopupImageEffectGlitchDescription:
      "Fallos digitales, cortes RGB y desplazamientos rápidos.",
    creatorPopupImageEffectInferno: "Infierno rubí",
    creatorPopupImageEffectInfernoDescription:
      "Llamas rubí, brasas y ondas de calor.",
    creatorPopupImageEffectNebula: "Nebulosa cósmica",
    creatorPopupImageEffectNebulaDescription:
      "Nubes cósmicas, estrellas y polvo espacial.",
    creatorProfileBattleClose: "Cerrar batalla",
    creatorProfileEditAddSocialLinkShort: "Agregar",
    creatorProfileEditBioPlaceholder:
      "Resumen corto para la parte superior del perfil.",
    creatorProfileEditCategoryPlaceholder: "Black Desert, MMORPG, Lives...",
    creatorProfileEditCloseAria: "Cerrar edición de perfil",
    creatorProfileEditDescriptionPlaceholder:
      "Cuenta más sobre el creador, la comunidad, el contenido y los objetivos.",
    creatorProfileEditNicknamePlaceholder: "Nombre del creador",
    creatorProfileEditPresentationEffects: "Efectos de presentación",
    creatorProfileEditPublicInfoDescription:
      "Actualiza solo la información pública que aparece en Cardpoc.",
    creatorProfileEditRemoveSocialLinkShort: "Eliminar",
    creatorProfileEditSelectSocialNetwork: "Selecciona la red",
    creatorProfileEditSocialLinksDescription:
      "Agrega enlaces públicos que aparecen en el perfil.",
    creatorProfileEditTagsHelp: "Separa las tags con comas.",
    creatorProfileEditTagsPlaceholder: "Streamer, MMORPG, Black Desert",
    creatorProfileEditTitlePlaceholder:
      "Streamer, creador, guild leader...",
    creatorProfileSaveChanges: "Guardar cambios",
    creatorProfileStatsActivateDrops:
      "Activar drops en lives puede acelerar colección, interacción y retorno al perfil.",
    creatorProfileStatsAverage: "Media",
    creatorProfileStatsAveragePerFan: "Media por fan",
    creatorProfileStatsCardpocProgress: "Progreso en Cardpoc",
    creatorProfileStatsClaimHelpsFollowers:
      "Reclamar y divulgar el perfil ayuda a activar los primeros seguidores.",
    creatorProfileStatsClose: "Cerrar estadísticas",
    creatorProfileStatsCollectedCards: "Cartas recolectadas",
    creatorProfileStatsCollection: "Colección",
    creatorProfileStatsCollectorsActive:
      "Este perfil ya tiene coleccionistas activos en Cardpoc.",
    creatorProfileStatsCollectorsStarting:
      "Este perfil aún está empezando su base de coleccionistas.",
    creatorProfileStatsCommunity: "Comunidad",
    creatorProfileStatsContinueDrops:
      "Sigue usando drops para transformar espectadores en participantes.",
    creatorProfileStatsDescription:
      "Resumen de crecimiento, colección y alcance del creador dentro y fuera de Cardpoc.",
    creatorProfileStatsEngagement: "Engagement",
    creatorProfileStatsExternalMetric: "Métrica externa",
    creatorProfileStatsExternalNetworks: "Redes externas",
    creatorProfileStatsFollowersHelp:
      "Los seguidores en Cardpoc ayudan al creador a ganar relevancia interna.",
    creatorProfileStatsGrowth: "Crecimiento",
    creatorProfileStatsGrowthDescription:
      "Cuanto más se visita, sigue, comparte, colecciona y usa en drops el perfil, más tiende a crecer dentro de Cardpoc.",
    creatorProfileStatsImpactSummary: "Resumen de impacto",
    creatorProfileStatsLive: "En vivo",
    creatorProfileStatsLiveNow: "En vivo ahora",
    creatorProfileStatsNextStep: "Próximo paso",
    creatorProfileStatsNoExternalMetrics:
      "Aún no hay métricas externas disponibles para este perfil.",
    creatorProfileStatsOffPlatformReach: "Alcance fuera de la plataforma",
    creatorProfileStatsPotential: "Potencial",
    creatorProfileStatsProfileHealth: "Salud del perfil",
    creatorProfileStatsProfileHealthDescription:
      "Puntuación estimada usando visitas, seguidores, compartidos, colección, drops y alcance externo ya disponibles en Cardpoc.",
    creatorProfileStatsQuickRead: "Lectura rápida",
    creatorProfileStatsQuickReadDescription:
      "Usa estos números para entender si el creador atrae visitas, convierte seguidores y genera colección dentro de la comunidad.",
    creatorProfileStatsReach: "Alcance",
    creatorProfileStatsStrengthActivePotential: "Potencial activo",
    creatorProfileStatsStrengthGrowing: "En crecimiento",
    creatorProfileStatsStrengthInitial: "Base inicial",
    creatorProfileStatsStrengthStrong: "Perfil fuerte",
    drops: "Drops",
    epicHunter: "Cazador Épico",
    epicHunterDescription: "Consigue una carta épica o superior.",
    legendaryHunter: "Cazador de Legendarias",
    legendaryHunterDescription:
      "Agrega una carta legendaria a tu colección.",
    levelTen: "Nivel 10",
    levelTenDescription: "Alcanza el nivel 10 como coleccionista.",
    levelUpToast: "Level up",
    loading: "Cargando",
    missionCompletedToast: "Misión completa",
    missionsCategoryBeginner: "Principiante",
    missionsCategoryCollection: "Colección",
    missionsCategoryCreators: "Creadores",
    missionsCategoryPacks: "Packs",
    missionsCategoryRarities: "Rarezas",
    missionsCategorySocial: "Social",
    newNotification: "Nueva notificación",
    obtainedFrom: "Origen",
    openPack: "Abrir pack",
    packOpenedToast: "Pack abierto",
    packReceivedToast: "Pack recibido",
    profileHighlightDescription:
      "Tu carta de mayor rareza obtenida hasta ahora.",
    profileHighlightEmpty:
      "Tu carta destacada aparecerá aquí cuando empieces a coleccionar.",
    profileHighlightTitle: "Destacado de la colección",
    rankingsCreatorMostRareCards: "Más cartas raras",
    rankingsCreatorMostRareCardsDescription:
      "Creadores con más cartas raras distribuidas.",
    rankingsEmptyDescription:
      "Este ranking aparece cuando haya suficientes registros reales en Cardpoc.",
    rankingsEmptyTitle: "Datos insuficientes",
    rankingsErrorNotice: "No fue posible cargar algunos datos ahora.",
    rankingsLoading: "Cargando datos reales...",
    rankingsRealDataNotice: "Rankings actualizados con datos reales.",
    rankingsYourProgressDescription:
      "Acompaña tu evolución en XP, cartas, packs y creadores seguidos.",
    rankingsYourProgressLoggedOutDescription:
      "Inicia sesión para ver tu posición real en XP, cartas, packs y creadores seguidos.",
    rankingsYourProgressTitle: "Tu progreso en los rankings",
    rareCollector: "Coleccionista Raro",
    rareCollectorDescription: "Ten al menos una carta rara o superior.",
    send: "Enviar",
    viewBadge: "Ver badge",
    viewCard: "Ver carta",
    viewers: "espectadores",
...
export const translations = {
  pt: {
    ...
    rewards: "Recompensas",
    rewardsEyebrow: "Central Cardpoc",
    rewardsTitle: "Recompensas diárias",
    rewardsDescription:
      "Resgate seu pacote diário e ganhe XP enquanto participa do Cardpoc.",
    closeRewards: "Fechar recompensas",
    dailyReward: "Recompensa diária",
    dailyRewardClaimed: "Pacote já resgatado",
    dailyRewardAvailable: "Pacote disponível",
    dailyRewardNext: "Próximo resgate: {date}",
    dailyRewardReady: "Seu pacote diário está pronto para resgate.",
    claimDailyReward: "Resgatar pacote",
    rewardAlreadyClaimed: "Já resgatado",
    rewardClaimSuccess: "Pacote diário resgatado: {pack}.",
    rewardClaimError: "Não foi possível resgatar agora.",
    openMyPacks: "Abrir meus pacotes",
    onlineXpReward: "XP online",
    onlineXpDescription: "Ganhe XP a cada {minutes} minutos ativo no site.",
    activeMinutes: "Minutos ativos",
    dailyXp: "XP do dia",
    rewardCycles: "Ciclos",
    nextXpReward: "Próximo XP",
    dailyLimitReached: "Limite",
    minutesShort: "{minutes} min",
    rewardStreakTitle: "Sequência diária",
    rewardStreakDescription:
      "Resgate todos os dias para liberar bônus melhores nas próximas fases.",
    streakDays: "{days} dia(s)",
    rewardPackCommon: "Pacote Comum",
    rewardPackRare: "Pacote Raro",
    rewardPackEpic: "Pacote Épico",
    rewardPackLegendary: "Pacote Lendário",
    rewardPackRandom: "Pacote Misterioso",
    ...
    adminCreatorDetector: "Detectar Criadores",
    adminCreatorDetectorAlreadyExists: "Já existe",
    ...
    adminCreatorDetectorDetectionSuccess: "Detecção concluída.",
    adminCreatorDetectorHidingRegistered: "Ocultando cadastrados",
    adminCreatorDetectorImportError:
      "Não foi possível importar os criadores selecionados.",
    adminCreatorDetectorImportSelected: "Importar selecionados",
    ...
    adminCreatorDetectorSelect: "Selecionar",
    adminCreatorDetectorSelected: "Selecionado",
  ...
  en: {
    ...
    rewards: "Rewards",
    rewardsEyebrow: "Cardpoc Hub",
    rewardsTitle: "Daily rewards",
    rewardsDescription:
      "Claim your daily pack and earn XP while you stay active on Cardpoc.",
    closeRewards: "Close rewards",
    dailyReward: "Daily reward",
    dailyRewardClaimed: "Pack already claimed",
    dailyRewardAvailable: "Pack available",
    dailyRewardNext: "Next claim: {date}",
    dailyRewardReady: "Your daily pack is ready to claim.",
    claimDailyReward: "Claim pack",
    rewardAlreadyClaimed: "Already claimed",
    rewardClaimSuccess: "Daily pack claimed: {pack}.",
    rewardClaimError: "Could not claim right now.",
    openMyPacks: "Open my packs",
    onlineXpReward: "Online XP",
    onlineXpDescription: "Earn XP every {minutes} active minutes on the site.",
    activeMinutes: "Active minutes",
    dailyXp: "Daily XP",
    rewardCycles: "Cycles",
    nextXpReward: "Next XP",
    dailyLimitReached: "Limit",
    minutesShort: "{minutes} min",
    rewardStreakTitle: "Daily streak",
    rewardStreakDescription:
      "Claim every day to unlock better bonuses in future phases.",
    streakDays: "{days} day(s)",
    rewardPackCommon: "Common Pack",
    rewardPackRare: "Rare Pack",
    rewardPackEpic: "Epic Pack",
    rewardPackLegendary: "Legendary Pack",
    rewardPackRandom: "Mystery Pack",
    ...
    adminCreatorDetector: "Detect Creators",
    adminCreatorDetectorAlreadyExists: "Already exists",
    ...
    adminCreatorDetectorDetectionSuccess: "Detection completed.",
    adminCreatorDetectorHidingRegistered: "Hiding registered",
    adminCreatorDetectorImportError:
      "Could not import the selected creators.",
    adminCreatorDetectorImportSelected: "Import selected",
    ...
    adminCreatorDetectorSelect: "Select",
    adminCreatorDetectorSelected: "Selected",
  ...
  es: {
    ...
    rewards: "Recompensas",
    rewardsEyebrow: "Central Cardpoc",
    rewardsTitle: "Recompensas diarias",
    rewardsDescription:
      "Reclama tu paquete diario y gana XP mientras participas en Cardpoc.",
    closeRewards: "Cerrar recompensas",
    dailyReward: "Recompensa diaria",
    dailyRewardClaimed: "Paquete ya reclamado",
    dailyRewardAvailable: "Paquete disponible",
    dailyRewardNext: "Próximo reclamo: {date}",
    dailyRewardReady: "Tu paquete diario está listo para reclamar.",
    claimDailyReward: "Reclamar paquete",
    rewardAlreadyClaimed: "Ya reclamado",
    rewardClaimSuccess: "Paquete diario reclamado: {pack}.",
    rewardClaimError: "No se pudo reclamar ahora.",
    openMyPacks: "Abrir mis paquetes",
    onlineXpReward: "XP online",
    onlineXpDescription: "Gana XP cada {minutes} minutos activo en el sitio.",
    activeMinutes: "Minutos activos",
    dailyXp: "XP del día",
    rewardCycles: "Ciclos",
    nextXpReward: "Próximo XP",
    dailyLimitReached: "Límite",
    minutesShort: "{minutes} min",
    rewardStreakTitle: "Racha diaria",
    rewardStreakDescription:
      "Reclama todos los días para desbloquear mejores bonos en próximas fases.",
    streakDays: "{days} día(s)",
    rewardPackCommon: "Paquete Común",
    rewardPackRare: "Paquete Raro",
    rewardPackEpic: "Paquete Épico",
    rewardPackLegendary: "Paquete Legendario",
    rewardPackRandom: "Paquete Misterioso",
    ...
    adminCreatorDetector: "Detectar Creadores",
    adminCreatorDetectorAlreadyExists: "Ya existe",
    ...
    adminCreatorDetectorDetectionSuccess: "Detección completada.",
    adminCreatorDetectorHidingRegistered: "Ocultando registrados",
    adminCreatorDetectorImportError:
      "No fue posible importar los creadores seleccionados.",
    adminCreatorDetectorImportSelected: "Importar seleccionados",
    ...
    adminCreatorDetectorMinViewers: "Viewers mín.",
    adminCreatorDetectorPlatform: "Plataforma",
    adminCreatorDetectorSelect: "Seleccionar",
    adminCreatorDetectorSelected: "Seleccionado",
