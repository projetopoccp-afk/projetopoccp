export const translations = {
  pt: {
    ...
    creatorRequestModalNicknamePlaceholder: "Nome público do creator",
    creatorRequestModalUsernamePlaceholder: "username-sem-arroba",
    creatorRequestModalVerificationTitle: "Verificação",
    creatorRequestModalVerificationUrlPlaceholder: "Link do canal, perfil ou rede social",
    creatorRequestModalVerificationCodeLabel: "Código de verificação",
    creatorRequestModalVerificationCodeDescription: "Use este código na descrição, bio ou post do seu canal/perfil para comprovar propriedade.",
    creatorRequestModalCardImageTitle: "Imagem da carta",
    creatorRequestModalCardImageDescription: "Envie uma imagem para representar sua carta na plataforma.",
    creatorRequestModalImageUrlPlaceholder: "URL da imagem da carta",
    creatorRequestModalUploading: "Enviando...",
    creatorRequestModalUploadImage: "Enviar imagem",
    creatorRequestModalImagePreviewAlt: "Prévia da carta",
    creatorRequestModalPromptTitle: "Prompt para gerar imagem",
    creatorRequestModalPromptDescription: "Use este prompt no ChatGPT para gerar uma arte no estilo da plataforma.",
  ...
  en: {
    ...
    creatorRequestModalSuccessTitle: "Request sent",
    creatorRequestModalSuccessDescription: "Your request has been sent for review.",
    creatorRequestModalTitle: "Become a Creator",
    creatorRequestModalDescription: "Submit your request to create your profile.",
    creatorRequestModalNicknamePlaceholder: "Creator public name",
    creatorRequestModalUsernamePlaceholder: "username-without-at",
    creatorRequestModalVerificationTitle: "Verification",
    creatorRequestModalVerificationUrlPlaceholder: "Channel, profile or social network link",
    creatorRequestModalVerificationCodeLabel: "Verification code",
    creatorRequestModalVerificationCodeDescription: "Use this code in your channel/profile description, bio or post to prove ownership.",
    creatorRequestModalCardImageTitle: "Card image",
    creatorRequestModalCardImageDescription: "Upload an image to represent your card on the platform.",
    creatorRequestModalImageUrlPlaceholder: "Card image URL",
    creatorRequestModalUploading: "Uploading...",
    creatorRequestModalUploadImage: "Upload image",
    creatorRequestModalImagePreviewAlt: "Card preview",
    creatorRequestModalPromptTitle: "Image generation prompt",
    creatorRequestModalPromptDescription: "Use this prompt in ChatGPT to generate artwork in the platform style.",
  ...
  es: {
    ...
    creatorRequestModalNicknamePlaceholder: "Nombre público del creator",
    creatorRequestModalUsernamePlaceholder: "username-sin-arroba",
    creatorRequestModalVerificationTitle: "Verificación",
    creatorRequestModalVerificationUrlPlaceholder: "Enlace del canal, perfil o red social",
    creatorRequestModalVerificationCodeLabel: "Código de verificación",
    creatorRequestModalVerificationCodeDescription: "Usa este código en la descripción, bio o publicación de tu canal/perfil para comprobar propiedad.",
    creatorRequestModalCardImageTitle: "Imagen de la carta",
    creatorRequestModalCardImageDescription: "Sube una imagen para representar tu carta en la plataforma.",
    creatorRequestModalImageUrlPlaceholder: "URL de la imagen de la carta",
    creatorRequestModalUploading: "Subiendo...",
    creatorRequestModalUploadImage: "Subir imagen",
    creatorRequestModalImagePreviewAlt: "Vista previa de la carta",
    creatorRequestModalPromptTitle: "Prompt para generar imagen",
    creatorRequestModalPromptDescription: "Usa este prompt en ChatGPT para generar un arte con el estilo de la plataforma.",
    creatorRequestModalCopied: "Copiado",
    creatorRequestModalCopy: "Copiar",
    creatorRequestModalOpenChatGPT: "Abrir ChatGPT",
    creatorRequestModalSubmitting: "Enviando...",
